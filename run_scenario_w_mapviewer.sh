...
# Test if there is there is no arg or arg is different than "local" as first argument of the script
if [ $# -eq 0 ] || [ "$1" != "local" ]; then
    ...
    echo -e "\e[1;44m  \e[1;33m ==================================================================== \e[0m "
    echo -e "\e[1;44m  \e[1;33m = Clean, local glassfish                                           = \e[0m "
    echo -e "\e[1;44m  \e[1;33m ==================================================================== \e[0m "
    ...
    echo -e "\e[1;44m  \e[1;33m ==================================================================== \e[0m "
    echo -e "\e[1;44m  \e[1;33m = Start local glassfish and deploy vlibtour-tour-management-bean   = \e[0m "
    echo -e "\e[1;44m  \e[1;33m ==================================================================== \e[0m "

    asadmin start-domain domain1
    asadmin start-database
    asadmin deploy "$VLIBTOURDIR/vlibtour-microservices/vlibtour-tour-management-system/vlibtour-tour-management-bean/target/vlibtour-tour-management-bean.jar"
fi
...
(
    cd ./vlibtour-applications/vlibtour-tour-management-admin-client || exit
...
(
    cd ./vlibtour-microservices/vlibtour-lobby-room-system/vlibtour-lobby-room-server || exit
...
(
    cd ./vlibtour-microservices/vlibtour-visit-emulation-system/vlibtour-visit-emulation-server || exit
...
(
    cd vlibtour-applications/vlibtour-tourist-application || exit
...
if [ $# -eq 0 ] || [ "$1" != "local" ]; then
    ...
    echo -e "\e[1;44m  \e[1;33m ========================================================== \e[0m "
    echo -e "\e[1;44m  \e[1;33m =    Clean, stop and remove local Glassfish              = \e[0m "
    echo -e "\e[1;44m  \e[1;33m ========================================================== \e[0m "
    asadmin undeploy vlibtour-tour-management-bean
    asadmin stop-database
    asadmin stop-domain domain1
