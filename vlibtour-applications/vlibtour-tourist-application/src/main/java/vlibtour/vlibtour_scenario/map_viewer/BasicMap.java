...
public class BasicMap extends JFrame implements JMapViewerEventListener {
	 ...
	 * the layer.
	 */
	private transient Layer markerLayer;
	...
	public BasicMap(final int zoomLevel) throws MalformedURLException {
		 ...
		 * copied in src/main/resources and then extracted from the jar archive
		 */
	 ...
	 * 
	 * @param mapMarker the marker to remove.
	 */
	 ...
	 * 
	 * @param mapMarker the marker to modify.
	 * @param type      its type.
	 ...
	 * 
	 * @param nameOfMarker marker to be added.
	 * @param markerLayer  the layer marker.
	 * @param markerName   name of the marker.
	 * @param markerValue  value to be written.
	 * @param lat          latitude position of the marker.
	 * @param lon          longitude position of the marker.
	 */
	 ...
	 * 
	 * @param nameOfMarker name of the marker.
	 ...
	 * 
	 * @param firstMarker name of the marker.
