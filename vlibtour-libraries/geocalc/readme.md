...
**Be careful! This module is obtained from GitHub (because there is no corresponding artefact published in a public Maven repository.**
...
*Note: Geocalc is not available from Maven's public repo. You need to run the download the source code, and to install it using Maven commands.* 
...
Point `otherPoint` will be 1000m away from Kew:
