...
public class DistanceTest {
    ...
    public void testZeroDistance() {
        ...
        assertEquals(0, EarthCalc.getDistance(kew, kew), 0);
    }
    ...
    public void testBearing() {
        ...
        assertEquals(198.4604614570758D, EarthCalc.getBearing(kew, richmond), 10E-5);
    }
    ...
    public void testBearingGitHubIssue3() {
        ...
        assertEquals(EarthCalc.getBearing(standpoint, forepoint), d.getDegreeCoordinate().getDecimalDegrees(), 10E-5);
    }
